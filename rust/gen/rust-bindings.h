...
DCERPCTransaction *rs_dcerpc_get_tx(void *vtx, uint64_t tx_id);
...
bool rs_dcerpc_log_json_record_tcp(const DCERPCState *state,
                                   const DCERPCTransaction *tx,
                                   JsonBuilder *jsb);

bool rs_dcerpc_log_json_record_udp(const DCERPCUDPState *state,
                                   const DCERPCTransaction *tx,
                                   JsonBuilder *jsb);
...
AppLayerResult rs_dcerpc_parse_request(Flow *flow,
                                       DCERPCState *state,
                                       void *_pstate,
                                       const uint8_t *input,
                                       uint32_t input_len,
...
AppLayerResult rs_dcerpc_parse_response(Flow *flow,
                                        DCERPCState *state,
                                        void *_pstate,
                                        const uint8_t *input,
                                        uint32_t input_len,
...
DCERPCTransaction *rs_dcerpc_udp_get_tx(void *state, uint64_t tx_id);
...
uint8_t rs_http2_tx_get_cookie(HTTP2Transaction *tx,
                               uint8_t direction,
...
uint8_t rs_http2_tx_get_header_names(HTTP2Transaction *tx,
                                     uint8_t direction,
                                     const uint8_t **buffer,
                                     uint32_t *buffer_len);

uint8_t rs_http2_tx_get_header_value(HTTP2Transaction *tx,
                                     uint8_t direction,
                                     const char *strname,
                                     const uint8_t **buffer,
                                     uint32_t *buffer_len);

uint8_t rs_http2_tx_get_headers(HTTP2Transaction *tx,
                                uint8_t direction,
                                const uint8_t **buffer,
                                uint32_t *buffer_len);

uint8_t rs_http2_tx_get_headers_raw(HTTP2Transaction *tx,
                                    uint8_t direction,
                                    const uint8_t **buffer,
                                    uint32_t *buffer_len);

uint8_t rs_http2_tx_get_host(HTTP2Transaction *tx,
                             const uint8_t **buffer,
                             uint32_t *buffer_len);

uint8_t rs_http2_tx_get_host_norm(HTTP2Transaction *tx,
                                  const uint8_t **buffer,
                                  uint32_t *buffer_len);

uint8_t rs_http2_tx_get_method(HTTP2Transaction *tx,
                               const uint8_t **buffer,
                               uint32_t *buffer_len);
...
uint8_t rs_http2_tx_get_status(HTTP2Transaction *tx,
                               const uint8_t **buffer,
                               uint32_t *buffer_len);

uint8_t rs_http2_tx_get_uri(HTTP2Transaction *tx,
                            const uint8_t **buffer,
                            uint32_t *buffer_len);

uint8_t rs_http2_tx_get_useragent(HTTP2Transaction *tx,
                                  const uint8_t **buffer,
                                  uint32_t *buffer_len);
